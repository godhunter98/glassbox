...
BANNER_LINES = [
    r"  _____ _                _____ _____ ____   ______   __",
    r" / ____| |        /\    / ____/ ____|  _ \ / __ \ \ / /",
    r"| |  __| |       /  \  | (___| (___ | |_) | |  | \ V /",
    r"| | |_ | |      / /\ \  \___ \\___ \|  _ <| |  | |> <",
    r"| |__| | |____ / ____ \ ____) |___) | |_) | |__| / . " + "\\",
    r" \_____|______/_/    \_\_____/_____/|____/ \____/_/ \_" + "\\",
]

TAGLINE  = "🔍 See through your code — a transparent coding assistant"
DIVIDER  = "─" * 80
